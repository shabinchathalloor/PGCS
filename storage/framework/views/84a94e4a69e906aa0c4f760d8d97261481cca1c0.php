...
<head>
    ...
    <meta name="keywords" content="materialize, admin template, dashboard template, flat admin template, responsive admin template,">
     <title><?php echo $__env->yieldContent('title'); ?> | Admin | PGCS </title>
                ...
                <div class="row">
                    ...
                    <div class="col col s8 m8 l8">
                        <ul id="profile-dropdown" class="dropdown-content">
                            ...
                            <li>
                              <a href="<?php echo e(route('admin::logout')); ?>" method="get"  ><i class="mdi-hardware-keyboard-tab"></i> <?php echo e(trans('messages.logout')); ?></a>
                            </li>
                        </ul>
