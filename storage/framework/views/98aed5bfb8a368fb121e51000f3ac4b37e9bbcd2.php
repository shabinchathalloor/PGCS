    ...
    <div class="container">
        ...
        <div class="card-panel">
                  ...
                  <table id="data-table-simple" class="display dataTable no-footer" cellspacing="0">
                    ...
                    <tbody>
                  <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  <?php
                   $complaint =  \App\Complaint::where('id',$task->complaint_id)->first();
                   ?>
                        <tr>
                            ...
                            <td>
                                  ...
                                  <a class="btn-floating btn-action waves-effect waves-light orange tooltipped" href="<?php echo e(route('admin::task.edit',['complaint'=>$complaint->id])); ?>" data-position=top data-tooltip="Update Status"><i class="mdi-communication-comment"></i></a>
