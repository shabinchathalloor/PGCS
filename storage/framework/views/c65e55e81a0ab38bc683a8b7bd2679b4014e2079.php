   ...
   <div id="breadcrumbs-wrapper">
    ...
    <div class="container">
        ...
        <div class="card-panel">
            <a class="btn-floating waves-effect waves-light green tooltipped" href="<?php echo e(route('admin::worker.create')); ?>" data-tooltip="Add New worker "><i class="mdi-content-add left"></i></a>
                  ...
                  <?php $__currentLoopData = $workers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $worker): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr>
                            ...
                            <td>
                                  ...
                                  <a class="btn-floating btn-action waves-effect waves-light orange tooltipped" href="<?php echo e(route('admin::worker.edit',['worker' =>$worker->id])); ?>" data-position=top data-tooltip="Edit"><i class="mdi-editor-mode-edit"></i></a>
                                  <a class="btn-floating btn-action waves-effect waves-light red tooltipped frmsubmit" href="<?php echo e(route('admin::worker.destroy',['worker'=>$worker->id])); ?>" data-position=top data-tooltip="<?php echo e(trans('messages.delete')); ?>" method="DELETE"><i class="mdi-action-delete"></i></a>
                            </td>
