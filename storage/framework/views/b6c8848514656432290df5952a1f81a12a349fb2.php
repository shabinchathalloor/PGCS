<?php $__env->startSection('title', 'Add Worker'); ?>
    ...
    <div class="row">
        <div class="col  m6  s12 offset-m3">
            <div class="card-panel">
                ...
                <?php endif; ?>
                    <form id="add"  method="post"  action="<?php echo e(route('administrator::worker.store')); ?>">
                            ...
                            <div class=" col s12 ">
                             ...
                             <div class="input-field col s12">
                                <label for="designation">Designation</label>
                                 <input id="designation" name="designation" type="text" data-error=".name">
                             </div>
                             </div>
