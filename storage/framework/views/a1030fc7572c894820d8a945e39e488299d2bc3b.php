                  ...
                  <?php $__currentLoopData = $complaints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $complaint): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr>
                            ...
                            <td>
                                  ...
                                  <a class="btn-floating btn-action waves-effect waves-light orange tooltipped" href="<?php echo e(route('admin::complaint.edit',['complaint'=>$complaint->id])); ?>" data-position=top data-tooltip="Allot worker"><i class="mdi-action-assignment-ind"></i></a>
